...
const ki = (e, t) => {
  ...
  Ie = (e) => (yo("data-v-f3dea5a8"), (e = e()), Co(), e),
  Zi = { class: "todo" },
  Xi = { class: "linea1" },
  Qi = Ie(() => M("h1", { class: "tituloprincipal" }, "💪GYMSTORE", -1)),
  Vi = { id: "carrito" },
  Gi = Ie(() =>
    M(
      "tr",
  ...
  nl = ["onClick"],
  sl = ["onClick"],
  rl = Ie(() => M("td", null, null, -1)),
  ol = Ie(() => M("td", null, "Total: ", -1)),
  il = pr(
    '<div class="linea2" data-v-f3dea5a8><div class="dentrolinea2" data-v-f3dea5a8><h2 class="titulolinea2" data-v-f3dea5a8>¿Interesado en algun producto?</h2><input class="barra" type="text" placeholder="Busca algun producto, ayuda, otros......" data-v-f3dea5a8></div></div><div class="linea3" data-v-f3dea5a8><h2 class="titulolinea3" data-v-f3dea5a8>PRODUCTOS</h2></div>',
    2
  ),
  ll = pr(
    '<div class="linea4" data-v-f3dea5a8><a class="titulolinea4" href="" data-v-f3dea5a8>MANCUERNAS</a><a class="titulolinea4" href="" data-v-f3dea5a8>COLCHONETAS</a><a class="titulolinea4" href="" data-v-f3dea5a8>BARRAS</a><a class="titulolinea4" href="" data-v-f3dea5a8>LAZOS</a><a class="titulolinea4" href="" data-v-f3dea5a8>BANDAS ELASTICAS</a></div>',
    1
  ),
  cl = { class: "linea5" },
  fl = { class: "cuadrotarjetas" },
  ul = ["src"],
  al = { class: "letra" },
  dl = Ie(() => M("b", null, "Nombre Del producto:", -1)),
  hl = Ie(() => M("b", null, "Nombre de la tienda:", -1)),
  pl = Ie(() => M("b", null, "Percio del producto:", -1)),
  gl = ["onClick"],
  _l = Ie(() => M("span", null, "Comprar", -1)),
  ml = [_l],
  bl = {
    __name: "App",
    setup(e) {
  ...
  xl = ki(bl, [["__scopeId", "data-v-f3dea5a8"]]);
zi(xl).mount("#app");
